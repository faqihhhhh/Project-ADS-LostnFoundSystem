...
def get_notifikasi(service: NotificationService = Depends(get_service), current_user: User = Depends(get_current_user)):
    return service.get_milik_saya(current_user.id)
